...
class LikeApiTest {
    ...
    void likeAndUnlikeTest() {
        ...
        ArticleLikeResponse response = read(articleId, 1L, "pessimistic-lock-1");
        ArticleLikeResponse response2 = read(articleId, 2L, "pessimistic-lock-1");
        ArticleLikeResponse response3 = read(articleId, 3L, "pessimistic-lock-1");
    ...
    ArticleLikeResponse read(Long articleId, Long userId, String lockType) {
